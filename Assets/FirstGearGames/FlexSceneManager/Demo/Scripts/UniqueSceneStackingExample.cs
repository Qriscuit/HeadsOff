...
namespace FirstGearGames.FlexSceneManager.Demos
{
    ...
    public class UniqueSceneStackingExample : MonoBehaviour
    {
        ...
        private void FlexSceneManager_OnLoadSceneEnd(LoadSceneEndEventArgs args)
        {
            ...
            if (args.RawData.ScopeType != SceneScopeTypes.Connections || args.RawData.Connections.Length == 0)
                return;
        ...
        private void LoadScene(NetworkIdentity triggeringIdentity)
        {
            ...
            * you wish to use when utilizing scene stacking. */
            ...
            FlexSceneManager.LoadConnectionScenes(triggeringIdentity.connectionToClient, ssd, asd, loadOptions);
        }
        ...
        private void UnloadScene(NetworkIdentity triggeringIdentity)
        {
            ...
            FlexSceneManager.UnloadConnectionScenes(triggeringIdentity.connectionToClient, asd);
        }

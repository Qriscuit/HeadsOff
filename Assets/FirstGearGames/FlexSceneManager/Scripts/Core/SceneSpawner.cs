...
namespace FirstGearGames.FlexSceneManager
{
    ...
    public static class SceneSpawner
    {
        ...
        {
            Scene scene = FlexSceneManager.ReturnScene(sceneReferenceData);
            return Instantiate<T>(scene, prefab, prefab.transform.position, prefab.transform.rotation, null, true);
        }
        /// <summary>
        /// Instantiates a prefab and moves it to a scene.
        ...
        {
            Scene scene = FlexSceneManager.ReturnScene(sceneHandle);
            return Instantiate<T>(scene, prefab, prefab.transform.position, prefab.transform.rotation, null, true);
        }
        /// <summary>
        /// Instantiates a prefab and moves it to a scene.
        ...
        {
            Scene scene = FlexSceneManager.ReturnScene(sceneName);
            return Instantiate<T>(scene, prefab, prefab.transform.position, prefab.transform.rotation, null, true);
        }
        #endregion

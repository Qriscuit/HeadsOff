...
namespace FirstGearGames.FlexSceneManager.Editors
{


    [CustomEditor(typeof(FlexSceneChecker), true)]
    ...
    public class FlexSceneCheckerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Script:", MonoScript.FromMonoBehaviour((FlexSceneChecker)target), typeof(FlexSceneChecker), false);
            GUI.enabled = true;
